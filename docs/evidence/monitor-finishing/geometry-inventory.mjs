 ...
 * Run: node docs/evidence/monitor-finishing/geometry-inventory.mjs [baseline] [output]
 */
...
const revision = process.argv[2] || '4a1f715';
...
const result = {
  ...
  method: [
    ...
    'Texture bytes are nominal RGBA8 texels including complete mip chains, not measured residency or browser canvas backing allocation. Counts reuse existing canvas textures.',
  ],
  excluded: [
