...
node scripts/walkway-shape-audit.mjs
node scripts/lighting-symbol-pairs-audit.mjs
...
See [the current validation evidence](docs/UNIFIED-CHASSIS-VALIDATION.md) and [the independent critic report](docs/CRITIC-REPORT.md).
