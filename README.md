...
The latest render-only changes and evidence are in [FLOATING-CALLOUTS-VALIDATION.md](docs/FLOATING-CALLOUTS-VALIDATION.md) and the independent [critic report](docs/CRITIC-REPORT.md).
