...
See [the current validation evidence](docs/HULL-BARS-VALIDATION.md) and [the independent critic report](docs/CRITIC-REPORT.md).
...
The latest correction removes the stray dark hull strips and seats projecting floor edges inside the chassis. Visual and geometry evidence are in [HULL-BARS-VALIDATION.md](docs/HULL-BARS-VALIDATION.md) and the [critic report](docs/CRITIC-REPORT.md). The preceding ladder-panel removal is retained in [PANEL-REMOVAL-VALIDATION.md](docs/PANEL-REMOVAL-VALIDATION.md). The earlier shoulder-strip removal is retained in [LADDER-LIP-VALIDATION.md](docs/LADDER-LIP-VALIDATION.md). Earlier interior standardization is retained in [PLAIN-INTERIORS-VALIDATION.md](docs/PLAIN-INTERIORS-VALIDATION.md).
