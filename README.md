...
See [the current validation evidence](docs/STAIRS-LIGHTING-VALIDATION.md) and [the independent critic report](docs/CRITIC-REPORT.md).
...
The latest correction keeps selected-room doorway surfaces steady when the ladder highlights. Visual and runtime evidence are in [STAIRS-LIGHTING-VALIDATION.md](docs/STAIRS-LIGHTING-VALIDATION.md) and the [critic report](docs/CRITIC-REPORT.md). The earlier shoulder-strip removal is retained in [LADDER-LIP-VALIDATION.md](docs/LADDER-LIP-VALIDATION.md). Earlier interior standardization is retained in [PLAIN-INTERIORS-VALIDATION.md](docs/PLAIN-INTERIORS-VALIDATION.md).
