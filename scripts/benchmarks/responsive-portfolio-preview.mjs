...
viewport.onchange=resize;document.querySelector('#room').onchange=event=>frame.src=event.target.value+audit;addEventListener('resize',resize);resize();
</script></body></html>`;
