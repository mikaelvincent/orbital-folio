...
import { PASSAGE_RADIUS } from '../../features/spacecraft/geometry/spacecraft-wall-layout.ts';
import { createSpacecraft } from '../../features/spacecraft/spacecraft-model.ts';
import {
  requiredPortalIds,
  interlockLadderPortals,
} from '../../features/spacecraft/navigation/iris-navigation.ts';
import { PRESSURE_WALL } from '../../features/spacecraft/geometry/spacecraft-wall-layout.ts';
