...
export function buildDockingShoulderEquipment(
  ...
  const m = {
    navy: material('tool-graphite', 0x25343e, 0.64, 0.12),
    alloy: material('tool-satin-alloy', 0xa2acae, 0.36, 0.56),
    amber: material('tool-retention-markers', 0xd3943e, 0.5, 0.2),
  };
  const mounts: any[] = [],
    tools: any[] = [],
    parts: string[] = [];
