...
export function PublicShell({
  ...
  return (
    <div
      className={`public-site room-${active}`}
      style={{ '--accent': data.site.accent } as React.CSSProperties}
    ...
    >
      ...
      <Header site={data.site} active={active} />
      <main
        id="main"
        tabIndex={-1}
        className={active === 'home' ? '' : 'room-main'}
      >
        {!data.site.sampleMode && !preview && (
          <script
            ...
            dangerouslySetInnerHTML={{
              __html: JSON.stringify({
                ...
                description: data.site.biography,
