        ...
        >
          ...
          <TabsContent value="inbox">
            <section className="studio-panel">
              ...
              <p>
                Messages are stored here. Email delivery is not configured.
                Reply using your own email application.
              </p>
              {!inbox.length && (
                <div className="studio-empty">
                  ...
                  <p>
                    Interview invitations and project conversations will appear
                    here.
                  </p>
                </div>
              )}
              {inbox.map((i) => (
                <article className="inquiry" key={i.id}>
                  ...
                  <button
                    className="quiet-button delete-button"
                    onClick={() =>
                      setPending({ action: 'inquiryDelete', id: i.id })
                    }
                  >
                    <Trash2 size={15} />
                    Delete message
              ...
              {moreInbox && (
                <button
                  ...
                  onClick={async () => {
                    const r = await fetch(
                      '/api/admin/inbox?offset=' + inbox.length,
                    );
                    const b: any = await r.json();
                    if (r.ok) {
            ...
            <div className="settings-grid">
              <section className="studio-panel">
                ...
                <p>
                  ...
                  Credentials, access lists, and private messages are excluded.
                  Uploaded image files are backed up separately from object
                  storage.
                </p>
                <a className="button" href="/api/admin/export">
                  <Download size={16} />
                ...
                <p className="editor-hint">
                  Import updates matching records without changing live
                  snapshots. Review and publish the imported drafts
                  individually.
                </p>
              </section>
              <section className="studio-panel">
                <h2>Owner access</h2>
                <p>
                  Only listed, signed-in ChatGPT identities may access this
                  studio. Share access only with people who should manage all
                  content and private inquiries.
                </p>
                      ...
                      {m.email !== email.toLowerCase() && (
                        <button
                          ...
                          onClick={async () => {
                            ...
                            if (r)
                              setMembers(members.filter((a) => a.id !== m.id));
                          }}
                        >
                          Revoke
                        </button>
              ...
              <section className="studio-panel audit-panel">
                ...
                <p>
                  Recorded server actions. Reload the studio to refresh this
                  list.
                </p>
